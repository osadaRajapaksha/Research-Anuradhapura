...
smote_export_df.to_csv('SMOTE_Combined_Training_Data_XGB.csv', index=False)
print(f"Saved -> 'SMOTE_Combined_Training_Data_XGB.csv'")
...
plt.xlabel('Algorithm Prediction')
plt.tight_layout()
plt.savefig('Matrix_4_SMOTE_Training_Data_XGB.png', dpi=300)
print("Saved -> 'Matrix_4_SMOTE_Training_Data_XGB.png'")
